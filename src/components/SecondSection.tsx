...
import IcopyIcon from "@/assets/svg/service/copy.svg";
import IcopyIconBold from "@/assets/svg/service/copy-bold.svg";
                ...
                <div className="col-sm-6">
                  <div className="service-box">
                    ...
                    <div className="service-content">
                      ...
                      <p>
                        Unleash the power of AI to effortlessly compelling
                ...
                <div className="col-sm-6">
                  <div className="service-box">
                    ...
                    <div className="service-content">
                      ...
                      <p>
                        Generate more engaging content to skyrocket your
            ...
            <div className="col-lg-6">
              <div className="service-info">
                <div>
                  ...
                  <p>
                    Introducing a revolutionary AI partner for creators across
                    the globe—a groundbreaking tool designed to transform the
                    way we bring our creative ideas to life. Unleash your
                    artistic abilities as you explore a world of limitless
                    possibilities. Say goodbye to obstacles and let this
                    remarkable AI companion pave the way to a new era of
                    boundless creation.
                  </p>
